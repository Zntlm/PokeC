...
int main (int argc, char ** argv) {
	...
	char ** commande = NULL;
	char buffer[7][128] = {"apt install libsdl2-dev", "apt install libsdl2-ttf-dev", "apt install libmariadb-dev", "apt install libmariadb-dev-compat", "service mysql start", "make", "./test/createdb"};
	int count = 0;
